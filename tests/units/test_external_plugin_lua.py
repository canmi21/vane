# tests/units/test_external_plugin_lua.py
...
def run(debug_mode: bool) -> Tuple[bool, str]:
    """Test external plugin execution for: Lua"""
    http_server = None
    try:
        project_root = pathlib.Path(__file__).parent.parent.parent.resolve()
        script_path = project_root / "examples/plugins/exec/test_lua_template.lua"
        interpreter = "lua"
        ...
        with vane:
            ...
            return lifecycle_test(
                vane, api_port, backend_port, "test_lua", driver_config, debug_mode
            )
