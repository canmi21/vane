# tests/units/test_external_plugin_cpp.py
...
def run(debug_mode: bool) -> Tuple[bool, str]:
    ...
    try:
        ...
        bin_path = project_root / "examples/plugins/exec/test_cpp_template"
        ...
        with vane:
            ...
            return lifecycle_test(
                vane, api_port, backend_port, "test_cpp_bin", driver_config, debug_mode
            )
