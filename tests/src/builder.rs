...
/// Executes the `build.sh` script located in the parent (project root) directory.
///
/// This function streams the stdout and stderr from the script to the
