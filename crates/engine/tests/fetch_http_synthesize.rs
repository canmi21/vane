...
//! `spec/crates/engine.md` `spec/crates/engine.md` § _Concrete fetches_ ("`HttpSynthesizeFetch` always produces `Body::Static`
...
async fn http_synthesize_returns_static_response() {
	// `spec/crates/engine.md` `spec/crates/engine.md` § _Concrete fetches_; preset alias from `spec/crates/core.md` § _Compile pipeline_:
...
async fn http_synthesize_with_headers() {
	// spec/crates/engine.md `spec/crates/engine.md` § _Concrete fetches_: synthesised responses carry
