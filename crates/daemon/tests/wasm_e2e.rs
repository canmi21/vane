...
//! config tree. The fixture component is generated by
//! `vane-testutil`'s build script (under the `wasm-fixtures`
//! feature) into its `OUT_DIR`; we copy it under a known stem so
//! the plugin reference name (`<stem>:probe`) is deterministic.
