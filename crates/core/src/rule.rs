...
impl TlsConfig {
	...
	/// Per-rule pre-lower validation per `spec/acme.md` § _Compile-time
...
/// `tls.managed` per `spec/acme.md` § _Configuration schema_.
///
...
mod tests {
	...
	// ─── tls.managed schema + validation (spec/acme.md § _Configuration schema_)
