...
pub async fn execute(
	...
	let allow_linker =
		env_loader::get_env("ALLOW_EXTERNAL_LINKER_ENV", "false".to_string()).to_lowercase() == "true";
	let allow_runtime =
		env_loader::get_env("ALLOW_EXTERNAL_RUNTIME_ENV", "false".to_string()).to_lowercase() == "true";
	let allow_shell =
